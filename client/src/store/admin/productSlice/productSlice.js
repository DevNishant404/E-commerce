...
export const editProduct=createAsyncThunk("/product/eidtProduct",async ({id,formData})=>{
    console.log(id)
...
export const deleteProduct=createAsyncThunk("/product/deleteProduct",async ({id,FormData})=>{
...
const adminrProductSlice=createSlice({
    name:"adminproducts",
    initialState,
    reducers:{},
...
export default adminrProductSlice.reducer
